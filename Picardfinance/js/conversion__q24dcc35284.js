/* ============================================================
   CONVERSION.JS — Picard Crédit Solutions
...
(function () {
  ...
  var EMAIL = 'contact@picardfinance.fr';
  ...
  function renderUrgencyBar() {
    ...
    bar.innerHTML = '<div class="ub-inner">'
      ...
      + '<a href="/contact.html" class="ub-cta">Profitez-en →</a>'
      + '</div>'
  ...
  function renderCallbackModal() {
    ...
    overlay.innerHTML =
      ...
      + '<p>Laissez vos coordonnées, un conseiller Picard vous rappelle gratuitement.</p>'
  ...
  function renderCookieConsent() {
    ...
    bar.innerHTML =
      '<div class="ck-inner">'
      + '<div class="ck-text">🍪 Ce site utilise des cookies pour améliorer votre expérience et analyser le trafic. <a href="/politique-confidentialite.html">En savoir plus</a></div>'
