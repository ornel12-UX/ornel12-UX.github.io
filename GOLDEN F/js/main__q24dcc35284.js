/* Golden Finances & Investment - main.js */
(function () {
  'use strict';
  ...
  const NAV_ITEMS = [
    { key: 'Accueil', href: '../index/index.html', id: 'home' },
    { key: 'Nos Services', href: '../services/index.html', id: 'services', children: [
      { key: 'Crédit immobilier', href: '../services_credit-immobilier/index.html' },
      { key: 'Rachat de crédit', href: '../services_rachat-credit/index.html' },
      { key: 'Assurance prêt', href: '../services_assurance-pret/index.html' },
      { key: 'Prêt professionnel', href: '../services_pret-professionnel/index.html' }
    ] },
    { key: 'Villes', href: '../villes/index.html', id: 'villes' },
    { key: 'Outils', href: '../outils_index/index.html', id: 'outils' },
    { key: 'Avis Clients', href: '../avis-clients/index.html', id: 'avis' },
    { key: 'À Propos', href: '../about/index.html', id: 'apropos' },
    { key: 'FAQ', href: '../faq/index.html', id: 'faq' },
    { key: 'Blog', href: '../blog/index.html', id: 'blog' },
    { key: 'Contact', href: '../contact/index.html', id: 'contact' },
  ];
  ...
  // Brand logo: Golden Finances & Investment mark (bar chart + arrow), rendered as a compact badge
  const LOGO_IMG = '<img src="../images/logo-icon.png" alt="Golden Finances &amp; Investment" loading="lazy"/>';
  const BRAND_MARKUP = '<span class="brand-mark" aria-hidden="true">' + LOGO_IMG + '</span>'
    + '<span class="brand-text">'
    + '<span class="brand-primary">Golden</span>'
    + '<span class="brand-sub">Finances &amp; Investment</span>'
    + '</span>';
  ...
  function initContactForm() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      postMail(payload).then(function () {
        ...
        console.error('[GFI] Erreur envoi contact', err);
        if (status) {
          var apiMessage = err && err.data && err.data.message ? String(err.data.message) : '';
          status.textContent = apiMessage || t(lang, 'contact.form.error', "Une erreur s'est produite. R\u00e9essayez ou \u00e9crivez-nous directement \u00e0 goldenfinanceinvestment7@gmail.com.");
  ...
  function initApplyForm() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      postMail(payload).then(function () {
        ...
        console.error('[GFI] Erreur envoi demande cr\u00e9dit', err);
        var apiMessage = err && err.data && err.data.message ? String(err.data.message) : '';
  ...
  function injectJsonLd() {
    const origin = (typeof window !== 'undefined' && window.location && window.location.origin) ? window.location.origin : 'https://goldenfinanceinvestment.fr';
    const page = (typeof window !== 'undefined' && window.location && window.location.href) ? window.location.href : origin + '/';
    const title = document.title || 'Golden Finances & Investment';
    const descMeta = document.querySelector('meta[name="description"]');
    const desc = descMeta ? descMeta.getAttribute('content') : '';
    const ORG_ID = 'https://goldenfinanceinvestment.fr/#organization';
    ...
    const breadcrumbs = {
      '@type': 'BreadcrumbList',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Accueil', item: 'https://goldenfinanceinvestment.fr/' },
      ],
    };
    if (pathSegs.length) {
    ...
    const graph = [
      {
        ...
        '@id': ORG_ID,
        name: 'Golden Finances & Investment',
        legalName: 'Golden Finances & Investment',
        alternateName: ['Golden Finances & Investment', 'GFI'],
        url: 'https://goldenfinanceinvestment.fr/',
        telephone: '+33756823279',
        email: 'goldenfinanceinvestment7@gmail.com',
        priceRange: '€€',
        foundingDate: '2010',
        ...
        address: {
          '@type': 'PostalAddress',
          streetAddress: '10/12 Rue du Général Foy',
          postalCode: '78000',
        ...
        makesOffer: [
          { '@type': 'Offer', name: 'Crédit immobilier', url: 'https://goldenfinanceinvestment.fr/credit-immobilier.html' },
          { '@type': 'Offer', name: 'Rachat de crédits', url: 'https://goldenfinanceinvestment.fr/rachat-credits.html' },
          { '@type': 'Offer', name: 'Crédit professionnel', url: 'https://goldenfinanceinvestment.fr/credit-professionnel.html' },
          { '@type': 'Offer', name: 'Assurance emprunteur', url: 'https://goldenfinanceinvestment.fr/assurance-pret.html' },
          { '@type': 'Offer', name: 'Crédit consommation', url: 'https://goldenfinanceinvestment.fr/credit-consommation.html' },
          { '@type': 'Offer', name: 'Crédit travaux', url: 'https://goldenfinanceinvestment.fr/credit-travaux.html' },
        ],
        aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '342' },
      },
      {
        '@type': 'WebSite',
        '@id': 'https://goldenfinanceinvestment.fr/#website',
        url: 'https://goldenfinanceinvestment.fr/',
        name: 'Golden Finances & Investment',
        ...
        potentialAction: {
          '@type': 'SearchAction',
          target: 'https://goldenfinanceinvestment.fr/?q={search_term_string}',
      ...
      },
      {
        ...
        name: title,
        description: desc,
        isPartOf: { '@id': 'https://goldenfinanceinvestment.fr/#website' },
        about: { '@id': ORG_ID },
